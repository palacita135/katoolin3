...
apt-key adv --keyserver keyserver.ubuntu.com --recv-keys ED444FF07D8D0BF6 || apt-key adv --keyserver keyserver.ubuntu.com:80 --recv-keys ED444FF07D8D0BF6 || die "This may be a server issue. Please try again later";
